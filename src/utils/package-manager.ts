...
import type { RaindropOptions } from './types';
...
export interface PackageManager {
  ...
  detect: ({ installDir }: Pick<RaindropOptions, 'installDir'>) => boolean;
  addOverride: (
    pkgName: string,
    pkgVersion: string,
...
export const BUN: PackageManager = {
  ...
  detect: ({ installDir }: Pick<RaindropOptions, 'installDir'>) =>
...
export function detectAllPackageManagers({
  installDir,
}: Pick<RaindropOptions, 'installDir'>): PackageManager[] {
